...
from algorithm import schedulingPP, schedulingSRTF, schedulingRR, schedulingNPPwRR, schedulingSJF, schedulingNPP, schedulingFCFS
...
class Second3(QWidget):
  ...
  def initUI(self):
    ...
    title = QLabel('Welcome {}'.format(str('User_3')), self)
    title.move(400,-200)
  ...
  def scheduling(self):
      if self.list is None:
          ...
          self.output = []
          GC, WT, TA, RT, AWT, ATT, ART = schedulingFCFS(self.data)
